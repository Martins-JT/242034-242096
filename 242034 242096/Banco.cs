...
namespace _242034_242096
{
    public class Banco
    {
        ...
        public static void FecharConexao()
        {
            try
            {
                // Fecha a conexão com obanco de dados -\_(  -_0  )_/-
                Conexao.Close();
            }
            catch (Exception e)
            {
        ...
        public static void CriarBanco()
        {
            try
            {
                ...
                Comando = new MySqlCommand("CREATE TABLE IF NOT EXISTS Marcas "
                    + "(id integer auto_increment primary key, " + "marca char(20))", Conexao);

                Comando.ExecuteNonQuery();

                Comando = new MySqlCommand("CREATE TABLE IF NOT EXISTS Categorias "
                  + "(id integer auto_increment primary key, " + "categoria char(20))", Conexao);
